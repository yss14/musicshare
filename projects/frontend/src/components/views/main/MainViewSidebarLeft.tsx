...
class MainViewSidebarLeftComponent extends React.Component<
  IMainViewSidebarLeftProps
> {
  @bind
  private onChangeDropdownShare(newShareIDHash: string) {
    this.props.history.push(
      this.props.match.path.replace(":shareID", newShareIDHash)
    );
  }
...
export const MainViewSidebarLeft = withRouter(
  connect(mapStateToProps)(MainViewSidebarLeftComponent)
);
