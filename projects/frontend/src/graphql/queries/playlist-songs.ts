...
export const usePlaylist = (variables: IGetPlaylistSongsVariables): QueryResult<IGetPlaylistSongsData, IGetPlaylistSongsVariables> => useQuery(PLAYLIST_WITH_SONGS, { variables });