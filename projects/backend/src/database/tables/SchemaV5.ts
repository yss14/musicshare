...
export namespace DatabaseV5 {
	...
	export const shares = TableSchema({
		...
		quota: { type: ColumnType.BigInt, nullable: false },
		quota_used: { type: ColumnType.BigInt, nullable: false, defaultValue: 0 },
	})
	...
	export const song_types = TableSchema({
		...baseSchema,
		song_type_id: { type: ColumnType.UUID, primaryKey: true, unique: true },
		name: { type: ColumnType.Varchar },
		group: { type: ColumnType.Varchar },
	...
	export const genres = TableSchema({
		...baseSchema,
		genre_id: { type: ColumnType.UUID, primaryKey: true, unique: true },
		name: { type: ColumnType.Varchar },
		group: { type: ColumnType.Varchar },
		share_id_ref: {
			type: ColumnType.UUID,
	...
	export const captchas = TableSchema({
		captcha_id: { type: ColumnType.UUID, primaryKey: true, nullable: false, createIndex: true },
		solution: { type: ColumnType.Varchar, nullable: false },
		...baseSchema,
	})
}

export namespace ViewsDefinitionsV5 {
...
export namespace ViewsV5 {
	export const ShareSongsView = View({
		views: ViewsDefinitionsV5,
