...
export const songZeroOliverSmith: ISongDBResult = {
	...
	date_removed: null,
	library_id_ref: libraryUser1ShareID,
}
...
export const songIsItLove: ISongDBResult = {
	...
	date_removed: null,
	library_id_ref: libraryUser2ShareID,
}
...
export const songThunder: ISongDBResult = {
	...
	date_removed: null,
	library_id_ref: libraryUser3ShareID,
}
...
export const createTestSongs = (libraryID: string, amount: number) => {
	...
	if (!__PROD__) {
		...
		for (const shareByUser of Object.values(testData.shares)) {
			await shareService.create(
				shareByUser.user_ids[0],
				shareByUser.name,
				shareByUser.is_library,
				shareByUser.share_id,
			)
