...
export const id3Samples: IID3SampleTest[] = [
	...
	},
	{
		...
		sample: {
			...
			comments:
				[{ value: 'someurl.com' },
				{ language: 'eng', description: '', value: 'someurl.com' }],
			track: 0,
			genre: '',
			band: 'someurl.com',
			...
			lyrics:
				[{ language: 'xxx', description: '', value: 'someurl.com' }],
		},
		expectedOutput: {
			...defaultExpectedOutput,
			title: 'Contact',
	...
	{
		originalFilename: 'Dimitri Vegas & Like Mike Vs. Vini Vici & Cherrymoon Trax - The House Of House (Extended Mix)',
		sample: {
			version: {
				v1: { major: 1, minor: 1 },
				v2: true
